module uniswap_v2::fixedpoint64 {
    ...
    public fun mul(uq: UQ64x64, y: u64): UQ64x64 {
        // vm would direct abort when overflow occurred
    ...
    public fun div(uq: UQ64x64, y: u64): UQ64x64 {
        assert!(y != 0, ERROR_DIVIDE_BY_ZERO);
    ...
    spec div {
        aborts_if y == 0 with ERROR_DIVIDE_BY_ZERO;
        ensures result.v == uq.v / y;
    }
    ...
    public fun fraction(numerator: u64, denominator: u64): UQ64x64 {
        assert!(denominator != 0, ERROR_DIVIDE_BY_ZERO);
